var gulp = require( 'gulp' ),
  ...
  var options = {};
  options.user = 'lntapley';
  options.port = 80;
  options.site_path = '~/Sites/alosta/app'; //this will point mamp to your local site
...
gulp.task( 'dist', () => {
  runSequence( [ 'php', 'css', 'js', 'images', 'fonts', 'vendorFonts', 'compile-js-lib', 'compile-css-lib' ], 'browser-sync' );
  // globbing
